...
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        long locationId;
        //queries the database for the parameters given
        ...
        //checks to see if there are any items with these parameters already
    ...
    private String[] getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            if ( cVVector.size() > 0 ) {
                ...
                ContentValues[] contentArray = new ContentValues[cVVector.size()];
                cVVector.toArray(contentArray);
                mContext.getContentResolver().bulkInsert(WeatherEntry.CONTENT_URI,contentArray);
            }
